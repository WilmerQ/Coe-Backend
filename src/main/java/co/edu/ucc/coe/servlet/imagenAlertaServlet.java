 ...
 * @author wilme
 */
@WebServlet(urlPatterns = {"/imagenalertaservlet"})
public class imagenAlertaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            System.out.println("id " + l + " tamaño foto " + am.getFoto().length);
            if (am != null) {
                byte[] imagen = am.getFoto();
